...
`;var RaceChartLoader=__name(()=>null,"RaceChartLoader");RaceChartLoader.afterDOMLoaded=`
  (function() {
    ...
    function initOrUpdate(newData) {
      console.log("\u{1F528} initOrUpdate \u2013 data:", newData);
      ...
      if (chartInstance) {
        ...
        console.log("\u{1F528} Creating Chart.js instance with config:", cfg);
...
<center>
  <label><input type="checkbox" id="bp-toggle" />\xD7BP</label>
  <br>
  <label><input type="checkbox" id="anger-toggle" />\xD7Anger</label>
</center>
</div>
